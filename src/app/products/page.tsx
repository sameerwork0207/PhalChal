...
export default async function ProductsPage() {
  ...
  const products = [
    { id: '1', name: 'Farm Fresh Sugarcane', category: 'Vegetables', price: 40, unit: 'bundle', farmer: { name: 'Vishwas Deshmukh' }, village: 'Dhamori', rating: 4.8, image: 'https://media.gettyimages.com/id/157608572/photo/sugar-cane-sticks-isolated-on-white-backdrop.jpg?s=1024x1024&w=gi&k=20&c=mZSzt_KdnBp_bUQqW6bFyV-ecjnpK1kVcmp5Mm5HmXc=' },
