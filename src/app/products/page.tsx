...
export default async function ProductsPage() {
  ...
  const products = [
    { id: '1', name: 'Farm Fresh Sugarcane', category: 'Vegetables', price: 40, unit: 'bundle', farmer: { name: 'Vishwas Deshmukh' }, village: 'Dhamori', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Sugarcane.jpg/600px-Sugarcane.jpg' },
    { id: '2', name: 'Sweet Pomegranate', category: 'Fruits', price: 120, unit: 'kg', farmer: { name: 'Shantaram Patil' }, village: 'Pohegoan', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Pomegranate_split.jpg/600px-Pomegranate_split.jpg' },
    ...
    { id: '4', name: 'Fresh Paneer', category: 'Dairy', price: 320, unit: 'kg', farmer: { name: 'Godawari Dairy' }, village: 'Kolpewadi', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Paneer_01.jpg/600px-Paneer_01.jpg' },
    { id: '5', name: 'Green Chilli', category: 'Vegetables', price: 60, unit: 'kg', farmer: { name: 'Ramesh Patil' }, village: 'Yesgoan', rating: 4.5, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Green_Chili_Pepper-_2013-10-31_17-45.jpg/600px-Green_Chili_Pepper-_2013-10-31_17-45.jpg' },
    ...
    { id: '9', name: 'Desi Ghee (Cow)', category: 'Dairy', price: 600, unit: 'liter', farmer: { name: 'Godawari Dairy' }, village: 'Kolpewadi', rating: 5.0, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Ghee.jpg/600px-Ghee.jpg' },
