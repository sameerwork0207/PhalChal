  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="mt-4 text-gray-500">Go to Products to add items to your cart.</p>
        <button onClick={() => router.push('/products')} className="mt-8 bg-green-600 text-white px-6 py-3 rounded-md font-medium">Browse Products</button>
      </div>
    );
  }
